                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" id="nombre_departamento" name="nombre_departamento"
                                ...
                                title="Solo se permiten letras y números, máximo 50 caracteres" required>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="tel" class="form-control" id="telefono_departamento"
                                name="telefono_departamento" pattern="[0-9]{1,20}" title="Ingrese solo números, máximo 20 caracteres"
                                required>
                        </div>
