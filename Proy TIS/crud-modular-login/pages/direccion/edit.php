            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="calle" placeholder="Calle" value="<?php echo $calle ?>" required>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label for="name" class="form-label">Número</label>
                        <input type="number" class="form-control" id="name" name="numero" placeholder="Número" step="1" value="<?php echo $numero ?>" required>
                    </div>

                    <div class="col-md-12 mb-3">
                        <label for="name" class="form-label">Número Piso/Oficina/Depto</label>
                        <input type="number" class="form-control" id="name" name="numero_departamento" placeholder="Número Piso/Oficina/Depto" step="1" value="<?php echo $numero_departamento ?>" aria-describedby="optional">
