            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="name" class="form-label">Nombre de la Region</label>
                        <input type="text" class="form-control" id="name" name="nombre_region" placeholder="Bío bío" value="<?php echo $nombre ?>" required>
                    </div>
